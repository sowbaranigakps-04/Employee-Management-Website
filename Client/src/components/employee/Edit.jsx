...
const Edit = () => {
    ...
    useEffect(() => {
        const fetchEmployee = async () => {
            try {
                const response = await axios.get(`https://employeehub.onrender.com/api/employee/${id}`, {
                    headers: {
...
const handleChange = (e) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://employeehub.onrender.com/api/employee/${id}`, employee, {
                headers: {
